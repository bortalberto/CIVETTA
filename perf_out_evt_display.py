...
class eff_calculation:
    ...
    def calc_eff(self):
        ...
        for put in range(0, 4):
            ...
            print(f"X: {eff_x_good:.3f} +/- {eff_x_good_error:.3f}")
            ...
            print(f"Real eff = {real_eff:.3f} +/- {error_real_eff:.3f}")
            print(f"---")
            ...
            print(f"Y: {eff_y_good:.3f} +/- {eff_y_good_error:.3f}")
        ...
        for put in range(0,4):
            ...
            print(f"2D eff = {eff_and_good:.3f} +/- {eff_and_good_error:.3f}")
            print(f"Real eff = {real_eff:.3f} +/- {error_real_eff:.3f}")
            print(f"---")
