...
def main(run, **kwargs):
    ...
    ### TPC options
    # Default from ini
    main_runner.tpc_prep.no_errors = bool(config["TPC"].get("no_errors"))
    main_runner.tpc_prep.no_first_last_shift = bool(config["TPC"].get("no_first_last_shift"))
    main_runner.tpc_prep.no_capacitive = bool(config["TPC"].get("no_capacitive"))
    main_runner.tpc_prep.drift_velocity = float(config["TPC"].get("drift_velocity"))
    main_runner.tpc_prep.no_time_walk_corr = bool(config["TPC"].get("no_time_walk_corr"))
    main_runner.tpc_prep.no_border_correction = bool(config["TPC"].get("no_border_correction"))
    main_runner.tpc_prep.no_prev_strip_charge_correction = bool(config["TPC"].get("no_prev_strip_charge_correction"))
